...
void InitLuaDoc()
{
    ...
    DOC_METHOD_1("int", "GetItem", "Get an array item at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index");
    DOC_METHOD_2("void", "SetItem", "Set an array item to a new value at the given index. The index must be valid. The first item is at index 1.",
    ...
    DOC_TABLE("util.ColorArrayInterface");
    DOC_METHOD_0("bool", "IsEmpty", "Check whether the array is empty or not.");
    DOC_METHOD_0("unsigned", "Size", "Get the number of items in the array.");
    DOC_METHOD_0("bool", "IsReadOnly", "Check whether the array is read only.");
    DOC_METHOD_1("base.Color4f", "GetItem", "Get an array item at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index");
    DOC_METHOD_2("void", "SetItem", "Set an array item to a new value at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index", "base.Color4f", "value");
    DOC_METHOD_0("void", "PopBack", "Pop the last item off of the array. If the array is empty nothing is done.");
    DOC_METHOD_0("void", "PopFront", "Pop the first item off of the array. If the array is empty nothing is done.");
    DOC_METHOD_0("base.Color4f", "First", "Get the first item in the array. The array must not be empty.");
    DOC_METHOD_0("base.Color4f", "Last", "Get the last item in the array. The array must not be empty.");
    DOC_METHOD_1("void", "PushBack", "Push back (append) a new item at the end of the array.", "base.Color4f", "value");

    DOC_TABLE("util.FloatArrayInterface");
    DOC_METHOD_0("bool", "IsEmpty", "Check whether the array is empty or not.");
    DOC_METHOD_0("unsigned", "Size", "Get the number of items in the array.");
    DOC_METHOD_0("bool", "IsReadOnly", "Check whether the array is read only.");
    DOC_METHOD_1("float", "GetItem", "Get an array item at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index");
    DOC_METHOD_2("void", "SetItem", "Set an array item to a new value at the given index. The index must be valid. The first item is at index 1.",
    ...
    DOC_METHOD_0("unsigned", "Size", "Get the number of items in the array.");
    DOC_METHOD_0("bool", "IsReadOnly", "Check whether the array is read only.");
    DOC_METHOD_1("bool", "GetItem", "Get an array item at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index");
    DOC_METHOD_2("void", "SetItem", "Set an array item to a new value at the given index. The index must be valid. The first item is at index 1.",
    ...
    DOC_METHOD_0("unsigned", "Size", "Get the number of items in the array.");
    DOC_METHOD_0("bool", "IsReadOnly", "Check whether the array is read only.");
    DOC_METHOD_1("string", "GetItem", "Get an array item at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index");
    DOC_METHOD_2("void", "SetItem", "Set an array item to a new value at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index", "string", "value");
    DOC_METHOD_0("void", "PopBack", "Pop the last item off of the array. If the array is empty nothing is done.");
    DOC_METHOD_0("void", "PopFront", "Pop the first item off of the array. If the array is empty nothing is done.");
    ...
    DOC_METHOD_0("unsigned", "Size", "Get the number of items in the array.");
    DOC_METHOD_0("bool", "IsReadOnly", "Check whether the array is read only.");
    DOC_METHOD_1("glm.vec2", "GetItem", "Get an array item at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index");
    DOC_METHOD_2("void", "SetItem", "Set an array item to a new value at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index", "glm.vec2", "value");
    DOC_METHOD_0("void", "PopBack", "Pop the last item off of the array. If the array is empty nothing is done.");
    DOC_METHOD_0("void", "PopFront", "Pop the first item off of the array. If the array is empty nothing is done.");
    ...
    DOC_TABLE("util.Vec3ArrayInterface");
    DOC_METHOD_0("bool", "IsEmpty", "Check whether the array is empty or not.");
    DOC_METHOD_0("unsigned", "Size", "Get the number of items in the array.");
    DOC_METHOD_0("bool", "IsReadOnly", "Check whether the array is read only.");
    DOC_METHOD_1("glm.vec3", "GetItem", "Get an array item at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index");
    DOC_METHOD_2("void", "SetItem", "Set an array item to a new value at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index", "glm.vec3", "value");
    DOC_METHOD_0("void", "PopBack", "Pop the last item off of the array. If the array is empty nothing is done.");
    DOC_METHOD_0("void", "PopFront", "Pop the first item off of the array. If the array is empty nothing is done.");
    DOC_METHOD_0("glm.vec3", "First", "Get the first item in the array. The array must not be empty.");
    DOC_METHOD_0("glm.vec3", "Last", "Get the last item in the array. The array must not be empty.");
    DOC_METHOD_1("void", "PushBack", "Push back (append) a new item at the end of the array.", "glm.vec3", "value");

    DOC_TABLE("util.Vec4ArrayInterface");
    DOC_METHOD_0("bool", "IsEmpty", "Check whether the array is empty or not.");
    DOC_METHOD_0("unsigned", "Size", "Get the number of items in the array.");
    DOC_METHOD_0("bool", "IsReadOnly", "Check whether the array is read only.");
    DOC_METHOD_1("glm.vec4", "GetItem", "Get an array item at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index");
    DOC_METHOD_2("void", "SetItem", "Set an array item to a new value at the given index. The index must be valid. The first item is at index 1.",
                 "unsigned", "index", "glm.vec4", "value");
    DOC_METHOD_0("void", "PopBack", "Pop the last item off of the array. If the array is empty nothing is done.");
    DOC_METHOD_0("void", "PopFront", "Pop the first item off of the array. If the array is empty nothing is done.");
    DOC_METHOD_0("glm.vec4", "First", "Get the first item in the array. The array must not be empty.");
    DOC_METHOD_0("glm.vec4", "Last", "Get the last item in the array. The array must not be empty.");
    DOC_METHOD_1("void", "PushBack", "Push back (append) a new item at the end of the array.", "glm.vec4", "value");
    ...
    DOC_METHOD_2("void", "SetViewport", "Set the game's logical (in game units) viewport that covers the currently visible part of the game world.<br>"
                 ...
                 "float", "width", "float", "height");
    DOC_METHOD_2("void", "SetCameraPosition", "Set the camera's game world position in game units.<br>"
                                      "Initially the camera is at 0.0, 0.0.",
                 "float", "x", "float", "y");
    DOC_METHOD_1("void", "SetCameraPosition", "Set the camera's game world position in game units.<br>"
                                      "Initially the camera is at 0.0, 0.0.",
                 "glm.vec2|base.FPoint", "position");
    DOC_METHOD_2("void", "TranslateCamera", "Apply a change to camera's game world position in game units.<br>"
                                              "Initially the camera is at 0.0, 0.0.",
                 "float", "x", "float", "y");
    DOC_METHOD_1("void", "TranslateCamera", "Apply a change to camera's game world position in game units.<br>"
                                              "Initially the camera is at 0.0, 0.0.",
                 "glm.vec2", "position");
    ...
    DOC_TABLE("game.AnimatorClass");
    DOC_METHOD_0("string", "GetName", "Get the animator class name.");
    ...
    DOC_METHOD_0("string", "GetClassId", "Get the animator class ID.");
    DOC_METHOD_0("string", "GetName", "Get the animator class name.");
    DOC_METHOD_0("string", "GetNodeId", "Get the entity node ID that the animator will apply on.");
    DOC_METHOD_0("float", "GetStartTime", "Get the animation time in seconds when the animator will start.");
    ...
    DOC_METHOD_1("void", "SetEndPosition", "Set the ending position for animator movement.<br>"
                                           "This takes effect only when the animator is not static.",
                 "glm.vec2", "position");
    DOC_METHOD_2("void", "SetEndPosition", "Set the ending position for animator movement.<br>"
                                           "This takes effect only when the animator is not static.",
                 "float", "x", "float", "y");
    DOC_METHOD_1("void", "SetEndScale", "Set the ending scale for animator movement.<br>"
                                           "This takes effect only when the animator is not static.",
                 "glm.vec2", "scale");
    DOC_METHOD_2("void", "SetEndScale", "Set the ending scale for animator movement.<br>"
                                           "This takes effect only when the animator is not static.",
                 "float", "x", "float", "y");
    DOC_METHOD_1("void", "SetEndSize", "Set the ending size for animator movement.<br>"
                                        "This takes effect only when the animator is not static.",
                 "glm.vec2", "scale");
    DOC_METHOD_2("void", "SetEndSize", "Set the ending size for animator movement.<br>"
                                        "This takes effect only when the animator is not static.",
                 "float", "x", "float", "y");
    DOC_METHOD_1("void", "SetEndRotation", "Set the ending rotation in radians for the animator movement.<br>"
                                           "This takes effect only when the animator is not static.",
                 "float", "angle");

    // todo:
    DOC_TABLE("game.BooleanPropertyAnimator");
    DOC_TABLE("game.PropertyAnimator");
    DOC_TABLE("game.KinematicAnimator");
    DOC_TABLE("game.MaterialAnimator");
    ...
    DOC_METHOD_1("game.Entity", "SpawnEntity", "Spawn a new entity in the scene with default arguments for everything.<br>",
                 "string", "klass_name");
    DOC_METHOD_2("game.Entity", "SpawnEntity", "Spawn a new entity into the scene.<br>"
                                               "Spawning a new entity doesn't immediately place the entity in the scene but will only add it to the list of "
                                               "entities to be spawned at the start of the next iteration of the game loop. "
                                               "After entities have been spawned they ill have their HasBeenSpawned flag on for a single iteration of the game loop.<br>"
                                               "Additionally 'BeginPlay' will be called on each spawned entity.<br><br>"
                                               "For performance reasons it's recommended to use 'async' spawning as much as possible.<br><br>"
                                               ...
                                               "If async is true the entity is spawned in the background and there's no guarantee when it will be placed into the scene.<br>"
                                               "If async is true the return value will be nil instead of the new entity object.<br><br>"
                                               "See below for the contents of the 'args' table.<br><br>"
                                               "<table style=\"width=100%\">"
                                               "<tr><th>Name</th><th>Type</th><th>Comment</th><th>Default val</th></tr>"
                                               "<TR><TD>id</TD><TD>string</TD><TD>Entity instance ID. All instance IDs MUST BE UNIQUE.<br>"
                                               "It's recommended to leave this one empty and a unique ID will be generated on spawn.</TD><TD>''</TD></TR>"
                                               "<TR><TD>name</TD><TD>string</TD><TD>Entity instance name.</TD><TD>''</TD></TR>"
                                               "<TR><TD>sx</TD><TD>float</TD><TD>Entity root node scale factor for X axis.</TD><TD>1.0</TD></TR>"
                                               "<TR><TD>sy</TD><TD>float</TD><TD>Entity root node scale factor for y axis.</TD><TD>1.0</TD></TR>"
                                               "<TR><TD>x</TD><TD>float</TD><TD>Entity root node translation for X axis.</TD><TD>0.0</TD></TR>"
                                               "<TR><TD>y</TD><TD>float</TD><TD>Entity root node translation for y axis.</TD><TD>0.0</TD></TR>"
                                               "<TR><TD>r</TD><TD>float</TD><TD>Entity root node rotation in radians around the Z axis.</TD><TD>0.0</TD></TR>"
                                               "<TR><TD>pos</TD><TD>glm.vec2</TD><TD>Entity root node translation vector (Alternative for x, y).</TD><TD>[0.0, 0.0]</TD></TR>"
                                               "<TR><TD>scale</TD><TD>glm.vec2</TD><TD>Entity root node scaling vector (Alternative for sx, sy).</TD><TD>[0.0, 0.0]</TD></TR>"
                                               "<TR><TD>logging</TD><TD>bool</TD><TD>Flag to enable/disable entity lifetime debug logging.</TD><TD>false</TD></TR>"
                                               "<TR><TD>link</TD><TD>bool</TD><TD>Flag to control linking entity to scene root in scene graph. </TD><TD>true</TD></TR>"
                                               "<TR><TD>link</TD><TD>async</TD><TD>Flag to control async spawning.</TD><TD>false</TD></TR>"
                                               "<TR><TD>layer</TD><TD>int</TD><TD>Entity render layer index in scene.</TD><TD>0</TD></TR>"
                                               "<TR><TD>delay</TD><TD>float</TD><TD>Time delay in seconds before placing entity into the scene and before it beings play.</TD><TD>0.0</TD></TR>"
                                               "<TR><TD>vars</TD><TD>table</TD><TD>Lua table for entity script variable values to set. Supports int, float, bool, string and vector types.<br>"
                                               "E.g. { my_var = 123 } where 'my_var' is the name of the entity variable. </TD><TD>nil</TD></TR>"
                                               "</table><br>",
