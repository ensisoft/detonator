-- UI Window 'fantasy' script.
-- This script will be called for every instance of 'fantasy'.
...
-- Optionally called on mouse events when the flag is set.S
