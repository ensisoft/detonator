...
void DlgSettings::on_btnSelectCodeEditor_clicked()
{
    QString filter;
    ...
    mUI.edtCodeEditorExecutable->setText(QDir::toNativeSeparators(executable));
    mUI.edtCodeEditorExecutable->setCursorPosition(0);
}
