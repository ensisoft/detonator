  ...
  , mStyle(style)
{
    ...
    std::vector<Property> props = {
        ...
        {"horizontal-scrollbar-background",          "widget", PropertyType::Material},
        {"horizontal-scrollbar-border",              "widget", PropertyType::Material},
        {"horizontal-scrollbar-border-width",        "widget", PropertyType::Float},
        {"horizontal-scrollbar-buttons-visible",     "widget", PropertyType::Bool},
        {"horizontal-scrollbar-handle",              "widget", PropertyType::Material},
        {"horizontal-scrollbar-handle-border",       "widget", PropertyType::Material},
        {"horizontal-scrollbar-handle-border-width", "widget", PropertyType::Float},
        {"horizontal-scrollbar-handle-shape",        "widget", PropertyType::Shape},
        {"horizontal-scrollbar-height",              "widget", PropertyType::Float},
        {"horizontal-scrollbar-shape",               "widget", PropertyType::Shape},
        ...
        {"vertical-scrollbar-background",            "widget", PropertyType::Material},
        {"vertical-scrollbar-border",                "widget", PropertyType::Material},
        {"vertical-scrollbar-border-width",          "widget", PropertyType::Float},
        {"vertical-scrollbar-buttons-visible",       "widget", PropertyType::Bool},
        {"vertical-scrollbar-handle",                "widget", PropertyType::Material},
        {"vertical-scrollbar-handle-border",         "widget", PropertyType::Material},
        {"vertical-scrollbar-handle-border-width",   "widget", PropertyType::Float},
        {"vertical-scrollbar-handle-shape",          "widget", PropertyType::Shape},
        {"vertical-scrollbar-width",                 "widget", PropertyType::Float},
        {"vertical-scrollbar-shape",                 "widget", PropertyType::Shape},
        ...
        {"horizontal-scrollbar-background",          "scroll-area", PropertyType::Material},
        {"horizontal-scrollbar-border",              "scroll-area", PropertyType::Material},
        {"horizontal-scrollbar-border-width",        "scroll-area", PropertyType::Float},
        {"horizontal-scrollbar-buttons-visible",     "scroll-area", PropertyType::Bool},
        {"horizontal-scrollbar-handle",              "scroll-area", PropertyType::Material},
        {"horizontal-scrollbar-handle-border",       "scroll-area", PropertyType::Material},
        {"horizontal-scrollbar-handle-border-width", "scroll-area", PropertyType::Float},
        {"horizontal-scrollbar-handle-shape",        "scroll-area", PropertyType::Shape},
        {"horizontal-scrollbar-height",              "scroll-area", PropertyType::Float},
        {"horizontal-scrollbar-shape",               "scroll-area", PropertyType::Shape},
        {"vertical-scrollbar-background",            "scroll-area", PropertyType::Material},
        {"vertical-scrollbar-border",                "scroll-area", PropertyType::Material},
        {"vertical-scrollbar-border-width",          "scroll-area", PropertyType::Float},
        {"vertical-scrollbar-buttons-visible",       "scroll-area", PropertyType::Bool},
        {"vertical-scrollbar-handle",                "scroll-area", PropertyType::Material},
        {"vertical-scrollbar-handle-border",         "scroll-area", PropertyType::Material},
        {"vertical-scrollbar-handle-border-width",   "scroll-area", PropertyType::Float},
        {"vertical-scrollbar-handle-shape",          "scroll-area", PropertyType::Shape},
        {"vertical-scrollbar-width",                 "scroll-area", PropertyType::Float},
        {"vertical-scrollbar-shape",                 "scroll-area", PropertyType::Shape},
